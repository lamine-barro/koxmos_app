...
function requestRealtimeResponse(link, sideband, reason) {
  ...
  sideband.send(JSON.stringify({ type: 'response.create', response: { output_modalities: ['audio'], max_output_tokens: 240 } }));
