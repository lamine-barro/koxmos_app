  ...
  async function toggle(silent = false) {
    if (!session) {
      ...
      try {
        ...
        setCall(kora); setSession({ id: billing.id, charged: 0 }); setState('Kora connecté');
