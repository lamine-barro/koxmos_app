...
const s = StyleSheet.create({
  ...
  metricRow: { flexDirection: 'row', gap: 12 }, flameCard: { flex: 1, minHeight: 90, borderWidth: 1, borderColor: '#D1D5DB', borderRadius: 16, padding: 14, backgroundColor: '#FFFBEB', flexDirection: 'row', alignItems: 'center', gap: 10 }, flameIcon: { fontSize: 30, color: '#D97706' }, flameCount: { color: '#111827', fontSize: 24, fontWeight: '800' }, flameLabel: { color: '#6B7280', fontSize: 12 }, walletCard: { flex: 1, minHeight: 90, borderWidth: 1, borderColor: '#D1D5DB', borderRadius: 16, padding: 14, backgroundColor: '#F9FAFB', justifyContent: 'center', gap: 5 }, cardAction: { flexDirection: 'row', alignItems: 'center', gap: 4 }, cardActionText: { color: '#4B5563', fontSize: 13 }, flameRule: { color: '#6B7280', fontSize: 12, marginTop: -8 }, modeGroup: { flexDirection: 'row', padding: 4, gap: 4, borderRadius: 14, backgroundColor: '#F3F4F6' }, modeButton: { flex: 1, minHeight: 44, borderRadius: 10, justifyContent: 'center', alignItems: 'center' }, modeButtonActive: { backgroundColor: '#111827' }, modeText: { color: '#4B5563', fontWeight: '800' }, modeTextActive: { color: '#fff' },
